vars_dict = {
    'app_name': 'base3', # Nom de l'arxiu ui sense extensio
    'form_name': 'Form', # Nom de la classe principal de la ui
    'promoted_name': 'LCDBase3', # Nom de la classe a la que hagis fet promote
    'inherited_from': 'QLCDNumber', # Nom de la classe de la qual hereda
